...
\hline
\# of diag.      & 4 & 25 & 220 & 2485 & 34300 & 559405 & 10525900 \\
\hline
\end{tabular}
\end{center}
\pause
...
\vspace{-1em}
\pause
$M_5=\!\!\!\!\!\!\underbrace{A_5[12345]}_{\textcolor{red}{\text{Color-ordered Amplitudes}}}\mathrm{Tr}[T^{a_1}T^{a_2}\cdots T^{a_5}]+\text{perms}$ ,\quad$+,-$ : helicity
    ...
    \pause
    \begin{gather*}
        p_\mu \sigma^\mu=p_{\alpha\dot{\alpha}}=\lambda_\alpha \tilde{\lambda}_{\dot{\alpha}}=\aket{\lambda}_\alpha[\lambda|_{\dot{\alpha}},\quad \sigma^\mu=(1,\vec{\sigma}),\\
        \aket{\lambda},\sket{\lambda}: \text{Weyl Spinors}
    \end{gather*}
\end{frame}
