...
\iffalse
\begin{frame}
    It is well known that in the conventional quantum field theory, S-matrix is a deduced physical quantity following
    ...
    Most of the developments before have made for particular theories like $\mathcal{N}=4$ Super Yang-Mills theory or $\mathcal{N}=8$ Supergravity,
...
\begin{frame}{}
    ...
    \begin{itemize}
        ...
        \item Positive geometry and Amplituhedra.
        \item \dots
    \end{itemize}
    \begin{figure}
        \centering
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        %In terms of this construction of amplitudes, it is easy to obtain the BCJ double copy relation. It may give some implications for the construcion of nonpermubative BCJ double copy.
...
\begin{frame}
    ...
    The measure can be written like %the n-3 integral can be completely determined by n-3 delta function
    \begin{equation*}
            \boxed{
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \end{equation*}
        It is easy to discover that the $i$th and $i+n$ th colums become identical, so the determinat and Pfaffian becomes 0.
        \pause
