...
\begin{equation}
    \varepsilon^\mu_{(IJ)}\varepsilon^{}_{(KL),\mu}=\frac{\abra{p_I}(r\cdot \Gamma)\Gamma^\mu\aket{p_J}}{4(p\cdot q)}\times \frac{\abra{p_K}(r\cdot \Gamma)\Gamma_\mu\aket{p_L}}{4(p\cdot q)}
    \label{7}
\end{equation}
...
\begin{align}
    \varepsilon^\mu_{IJ}\varepsilon^{}_{KL,\mu}&=\frac{\abra{p_I}^A\aket{r_M}_A\abra{r^M}^B(\Gamma^\mu)_B^{\ C}\aket{p_J}_C \abra{p_K}^D\aket{r_N}_D\abra{r^N}^E(\Gamma_\mu)_D^{\ F}\aket{p_L}_F}{16(p\cdot q)^2}\notag \\
    &=\frac{\inner{p_I}{r_M}\inner{p_K}{r_N}}{16(p\cdot q)^2}\times \abra{r^M}^B(\Gamma^\mu)_B^{\ C}\aket{p_J}_C \abra{r^N}^E(\Gamma_\mu)_E^{\ F}\aket{p_L}_F
    \label{10}
\end{align}
