...
\begin{gather}
    ...
    \hat{\delta}_i{}^A\hat{\delta}_{i^\prime A}=\hat{i}^a i^A{}_{a} \hat{i^\prime}^b i^\prime_{Ab}=\hat{i}^a\hat{i^\prime}^b y^{ii^\prime}{}_{ab}=\hat{i}^a\hat{i^\prime}^b i_a i^\prime _b=0
\end{gather}
